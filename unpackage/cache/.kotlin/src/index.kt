...
fun nanoid(size: Number = 21, prefix: String = "T"): String {
    var id = "";
    var i = size;
    while(i-- != 0){
        id += urlAlphabet[(Math.random() * 64) or 0];
    }
    return prefix + id;
}
open class CheckedPayload (
    @JsonNotNull
    open var id: String,
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CheckedPayload", "common/type.uts", 1, 13)
    }
}
open class Item (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Item", "common/type.uts", 5, 13)
    }
...
open class ItemReactiveObject : Item, IUTSReactive<Item> {
    ...
    constructor(__v_raw: Item, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(id = __v_raw.id, text = __v_raw.text, checked = __v_raw.checked) {
...
val GenComponentsUTodoItemUTodoItemClass = CreateVueComponent(GenComponentsUTodoItemUTodoItem::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(name = GenComponentsUTodoItemUTodoItem.name, inheritAttrs = GenComponentsUTodoItemUTodoItem.inheritAttrs, inject = GenComponentsUTodoItemUTodoItem.inject, props = GenComponentsUTodoItemUTodoItem.props, propsNeedCastKeys = GenComponentsUTodoItemUTodoItem.propsNeedCastKeys, emits = GenComponentsUTodoItemUTodoItem.emits, components = GenComponentsUTodoItemUTodoItem.components, styles = GenComponentsUTodoItemUTodoItem.styles);
}
, fun(instance): GenComponentsUTodoItemUTodoItem {
    return GenComponentsUTodoItemUTodoItem(instance);
}
);
val GenComponentsUActionUActionClass = CreateVueComponent(GenComponentsUActionUAction::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(name = GenComponentsUActionUAction.name, inheritAttrs = GenComponentsUActionUAction.inheritAttrs, inject = GenComponentsUActionUAction.inject, props = GenComponentsUActionUAction.props, propsNeedCastKeys = GenComponentsUActionUAction.propsNeedCastKeys, emits = GenComponentsUActionUAction.emits, components = GenComponentsUActionUAction.components, styles = GenComponentsUActionUAction.styles);
}
, fun(instance): GenComponentsUActionUAction {
    return GenComponentsUActionUAction(instance);
}
);
val default1 = "/static/empty.png";
val storageKey = "uiappx-todo-list";
...
open class UniAppConfig : AppConfig {
    override var name: String = "今天吃点什么";
...
fun definePageRoutes() {
    __uniRoutes.push(PageRoute(path = "pages/index/index", component = GenPagesIndexIndexClass, meta = PageMeta(isQuit = true), style = utsMapOf("navigationBarTitleText" to "任务")));
}
val __uniTabBar: Map<String, Any?>? = null;
val __uniLaunchPage: Map<String, Any?> = utsMapOf("url" to "pages/index/index", "style" to utsMapOf("navigationBarTitleText" to "任务"));
@Suppress("UNCHECKED_CAST")
fun defineAppConfig() {
    __uniConfig.entryPagePath = "/pages/index/index";
    __uniConfig.globalStyle = utsMapOf("navigationBarTextStyle" to "white", "navigationBarTitleText" to "todoList", "navigationBarBackgroundColor" to "#b92ddb", "backgroundColor" to "#b92ddb");
