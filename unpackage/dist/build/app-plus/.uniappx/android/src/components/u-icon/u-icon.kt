...
open class GenComponentsUIconUIcon : VueComponent {
    ...
    companion object {
        ...
        var props = normalizePropsOptions(utsMapOf("code" to utsMapOf("type" to "String", "required" to true), "color" to utsMapOf("type" to "String", "default" to "black"), "size" to utsMapOf("type" to "String", "default" to "25px")));
